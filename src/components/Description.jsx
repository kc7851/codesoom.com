        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <h2 className="h2-heading">
              Marketing Automation Will Bring More
              Qualified Leads
            </h2>
          </div>
        </div>
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-image">
                <img
                  className="img-fluid"
                  src="src/images/description-1.png"
                  alt="alternative"
                />
              </div>
            ...
            <div className="card">
              <div className="card-image">
                <img
                  className="img-fluid"
                  src="src/images/description-2.png"
                  alt="alternative"
                />
              </div>
              <div className="card-body">
                ...
                <p>
                  ...
                  because it's at the core of Tivo's
                  functionalities
                </p>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-image">
                <img
                  className="img-fluid"
                  src="src/images/description-3.png"
                  alt="alternative"
                />
              </div>
              <div className="card-body">
