        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <p className="p-heading">
              ...
              your marketing tasks to save
              time for product development. Tivo can provide results in
              less than 2 weeks
            </p>
          </div>
        </div>
                  ...
                  <div className="col-lg-6">
                    <div className="text-container">
                      ...
                      <p>
                        ...
                        {' '}
                        and you will receive access to the
                        app and all of its features in no more than 24h.
                      </p>
                      <ul className="list-unstyled li-space-lg">
                        <li className="media">
                          ...
                          <div className="media-body">
                            Create and embed on
                            websites newsletter sign up forms
                          </div>
                        </li>
                        <li className="media">
                          <i className="fas fa-square" />
                  ...
                  <div className="col-lg-6">
                    <div className="text-container">
                      ...
                      <p>
                        ...
                        Tivo and basically to any marketing activity focused on
                        results.
                      </p>
                      <ul className="list-unstyled li-space-lg">
                        <li className="media">
                  ...
                  <div className="col-lg-6">
                    <div className="text-container">
                      ...
                      <p>
                        ...
                        team so it's beed implemented from the
