const privayPolicies = [
  {
    head: '1. 개인정보의 처리 목적',
    body: `<스타트스몰>('https://www.codesoom.com'이하 '코드숨')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
...
서비스 제공, 청구서 발송, 콘텐츠 제공, 요금결제·정산 등을 목적으로 개인정보를 처리합니다.`,
  ...
  {
    head: '3. 개인정보의 처리 및 보유 기간',
    body: `① <스타트스몰>('코드숨')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.
...
<제화 또는 서비스 제공>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<3년>까지 위 이용목적을 위하여 보유.이용됩니다.
  ...
  {
    head: '4. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.',
    body: `① 정보주체는 스타트스몰에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.
...
⑥ 스타트스몰은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.`,
  ...
  {
    head: '5. 처리하는 개인정보의 항목 작성',
    body: `① <스타트스몰>('https://www.codesoom.com'이하 '코드숨')은(는) 다음의 개인정보 항목을 처리하고 있습니다.

1<홈페이지 회원가입 및 관리>
    - 필수항목 : 서비스 이용 기록, 접속 로그, 쿠키, GIthub 계정`,
  },
  {
    head: '6. 개인정보의 파기<스타트스몰>(\'코드숨\')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.',
    body: `- 파기절차
...
전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다.`,
  ...
  {
    head: '7. 개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항',
    body: `① 스타트스몰 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다.
② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.
  ...
  {
    head: '8. 개인정보 보호책임자 작성',
    body: `① 스타트스몰(‘https://www.codesoom.com’이하 ‘코드숨) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
...
② 정보주체께서는 스타트스몰(‘https://www.codesoom.com’이하 ‘코드숨) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 스타트스몰(‘https://www.codesoom.com’이하 ‘코드숨) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.`,
  ...
  {
    head: '10. 개인정보의 안전성 확보 조치 <스타트스몰>(\'코드숨\')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.',
    body: `1. 정기적인 자체 감사 실시
